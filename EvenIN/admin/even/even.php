...
<body>
	...
	<div class="container">
		...
		<p>
			<a href="tambah.php" class="btn btn-primary">Tambah Acara</a>
		</p>
					...
					<?php
						...
						while ($data = mysqli_fetch_array($exec)) {
							...
							<tr>
								...
								<td>
									<a href="edit.php?id=<?=$data['id_acara']?>" class="btn btn-success">Edit</a>
									<a href="hapus.php?id=<?=$data['id_acara']?>" class="btn btn-danger">Hapus</a>
								</td>
							</tr>
							<?php
						$no++;	
