...
<body>
	...
	<div class="container">
		...
		<div class="row col-sm-12 col-md-6">	
			<form action="insert_kategori.php" method="post" name="isidatakategori" class="form-group">

				<p>
					<label>Nama kategori</label>
					<input type="text" name="nm_kat" placeholder="Judul kategori" class="form-control">
				</p>
				<p>
